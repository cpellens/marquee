...
final class Query
{
    ...
    public function get(bool $cache = true): QueryResult
    {
     ...
     * @return WhereCondition[]|UpdateCondition[]|CreateCondition[]
     */
    ...
    private function getCached(): QueryResult
    {
        $hash = $this->getHash();

        if (!isset(static::$cache[ $hash ])) {
            static::$cache[ $hash ] = $this->execute();
        }
